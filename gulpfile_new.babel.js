  ...
  return gulp.src(settings.pages.src + '/pages/**/*')
    ...
    .pipe(
      ms
        ...
        .use(msCollections(settings.collections.defined))
        .use(msCollectionMetadata(settings.collections.defaults))
        .use(msBranch()
...
export function manageCollectionsOutput() {
  return del(settings.metadata.collections.delete);
}
...
export function images() {
  return gulp.src(`${settings.images.src}/**/*`)
    ...
    .pipe($.if(DEPLOY, gulp.dest(settings.images.dest.dist), gulp.dest(settings.images.dest.dist)));
}
...
export function removeAPIAttr() {
  ...
  return gulp.src(`${src}/**/*.html`)
    ...
    .pipe($.if(DEPLOY, settings.dest.dist, settings.dest.build));
}
